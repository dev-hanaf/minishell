...
// " after " ==> no quotes ==> ex: ""$HOME"" --> $HOME
// ' after ' ==> no quotes ==> ex: ''$HOME'' --> $HOME
// " after ' ==> expansion works fine, but s_quotes still exist  ==> ex: "''''$HOME''''" ==> ''''/nfs/homes/ahanaf''''


//  "''"''''$HOME''''"''" ==> in this example result --> ''/nfs/homes/ahanaf'' , there is no existance of single quotes after the second double quotes


//if_exist_in_s_quotes_or_d_quotes('$', command)
